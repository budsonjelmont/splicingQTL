...
covPath='/sc/orga/projects/EPIASD/splicingQTL/intermediate_files/covar/'
covFile='leafcutter-input_covar.4genoPCs.idsync.10splicingPCs.deduped.minCovars.txt'
...
bedPath='/sc/orga/projects/EPIASD/splicingQTL/intermediate_files/pheno/'
outPath='/sc/orga/projects/EPIASD/splicingQTL/intermediate_files/fqtl_output/deduped_mincovars_noHCPs/'
