...
covarsfile = '/sc/orga/projects/EPIASD/splicingQTL/intermediate_files/covar/leafcutter-input_covar.4genoPCs.idsync.10splicingPCs.deduped.dropcovars.10HCPs.txt'
...
#form = ~ (1|Group) + ageDeath + ageDeath.squared + (1|study) + (1|sex) + PMI + RIN + RIN.squared + (1|individualIDSource) + (1|tissue) + seqPC3.squared + seqPC1 + seqPC2 + seqPC3 + seqPC4 + seqPC5 + seqPC6 + seqPC7 + seqPC8 + seqPC9 + seqPC10 + seqPC11 + seqPC12 + seqPC13 + seqPC14 + seqPC15 + seqPC16 + seqPC17 + seqPC18 + seqPC19 + seqPC20 + seqPC21 + seqPC22 + seqPC23 + seqPC24 + seqPC25 + seqPC26 + seqPC27 + seqPC28 + seqPC29 + genotypePC1 + genotypePC2 + genotypePC3 + genotypePC4 # ALL covariates, no HCPs
