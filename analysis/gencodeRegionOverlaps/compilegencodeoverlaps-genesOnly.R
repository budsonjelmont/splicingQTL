...
# OR /sc/arion/projects/EPIASD/splicingQTL/analysis/annotationBEDs/Walker2018_data/WalkerCell_significantSQTLS.dummycols.bed
overlapdir = args[2] #'/sc/arion/projects/EPIASD/splicingQTL/intermediate_files/fqtl_output_wasp/20genoPCs_nogenoInHCP/deduped_mincovars+seqPC9_15HCPs/gencodeOverlaps/'
# OR /sc/arion/projects/EPIASD/splicingQTL/analysis/annotationBEDs/PECisoqtls/gencodeOverlaps/
# OR /sc/arion/projects/EPIASD/splicingQTL/analysis/annotationBEDs/Walker2018_data/gencodeOverlaps_genesOnly-redundantSNPs
