...
inbed=/sc/hydra/projects/pintod02c/isoseq_MAP/track_hub2/tama_capped_a100_cagedistfix/map-paper-merge-capped-a100-cagedistfix_corrected.bed # BEDfile containing all transcripts from our map
outbed=$2 # Path & name of output bedfile
...
grep -E '^chr[0-9]{1,2}' ${outbed}.tmp > ${outbed}
