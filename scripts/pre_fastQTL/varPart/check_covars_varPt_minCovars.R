...
colnames(vp) = paste(colnames(vp),' (',as.character(signif(vp_summary['Median',],3)*100),'%)',sep='')
fig = plotVarPart( vp )
#fig = plotVarPart( vp , xlab=paste(colnames(vp),' (',as.character(vp['Median',]),'%)',sep=''))
...
#reform = ~ study + sex + RIN + RIN.squared + tissue + seqPC1 + seqPC2 + seqPC4 + seqPC6 + seqPC7 + seqPC8 + seqPC9 + seqPC11 + + genotypePC1 + genotypePC2 + genotypePC3 + genotypePC4 + genotypePC5 + genotypePC6 + genotypePC7 + genotypePC8 + genotypePC9 + genotypePC10 + genotypePC11 + genotypePC12 + genotypePC13 + genotypePC14 + genotypePC15 + genotypePC16 + genotypePC17 + genotypePC18 + genotypePC19 + genotypePC20 #+ HCP1 + HCP2 + HCP3 + HCP4 + HCP5 + HCP6 + HCP7 + HCP8 + HCP9 + HCP10 + HCP11 + HCP12 + HCP13 + HCP14 + HCP15 + HCP16 + HCP17 + HCP18 + HCP19 + HCP20 # ALL covariates
