...
resdir = '/sc/arion/projects/EPIASD/splicingQTL/analysis/annotationBEDs/PECcQTLs/'
resfile = 'DER-09_hg19_cQTL.significant.txt'
...
res['score']=res['regression_slope']

res['Peak_end']=res['Peak_center']+1
...
standardizedcoldict={
  ...
  'SNP_start':'sid_start',
  'SNP_end':'sid_end',
  'SNP_distance_to_Peak_center':'dist',
  'Peak_id':'pid',
  'Peak_chr':'pid_chr',
  'Peak_center':'pid_start',
  'Peak_end':'pid_end',
...
phenobedcols=['pid_chr','pid_start','pid_end','pid','score','strand']
...
snpbedcols=['sid_chr','sid_start','sid_end','sid','score','strand']
