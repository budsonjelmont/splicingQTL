...
resdir = '/sc/arion/projects/EPIASD/splicingQTL/analysis/annotationBEDs/Walker2018_data/eQTLs/'
resfile = 'WalkerCell_significanteQTLS.txt'
...
res['variant_id']=res['chr'].astype(str)+':'+res['pos'].astype(str)

# After creating variant_id, prefix 'chr' to chr #
res['chr'] = 'chr'+res['chr'].astype(str)
res['gene_chr'] = 'chr'+res['gene_chr'].astype(str)
...
phenobedcols=['pid_chr','pid_start','pid_end','pid','score','strand_dummy']
...
snpbedcols=['sid_chr','sid_start','sid_end','sid','score','strand_dummy']
